...
# base_dir is one up from the settings dir (e.g <repo>/mote/)
# root_dir is the repo directory (e.g <repo>/)
...
WSGI_APPLICATION = 'mote.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(ROOT_DIR, 'mote.sqlite3'),
    }
}
